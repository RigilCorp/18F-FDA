...
angular.module('angucomplete', [] )
    ...
    return {
        ...
        controller: function ( $scope ) {
            ...
            $scope.pause = 500;
            $scope.minLength = 3;
            $scope.searchStr = $scope.prefernce.searchStr;
            ...
            $scope.searchTimerComplete = function(str) {
                ...
                if (str.length >= $scope.minLength) {
                    if ($scope.localData) {
                        ...
                        $scope.searchedobject.searchedKeyword = str;
                        $scope.searchedobject.match = matches.length;
                        if(matches.length <= 0) $scope.showDropdown=false;
                        $scope.$apply();
